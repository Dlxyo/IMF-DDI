...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=2):  # 保证特征数量大于等于2
...
if __name__ == "__main__":
    ...
    log_file_path = 'imf_drugbank.txt'  # You can change the file path as needed
    best_model_path = "imf_drugbank.pth"
    node_file_path = 'Drugbank/pkl/drugbank_drug.pkl'
    edge_file_path = 'Drugbank/pkl/drugbank_event.pkl'
